...
function Contact() {
  ...
  const { loading, success, contact } = contactCreate;
  ...
  useEffect(() => {
    ...
    function formSubmit(e) {
      ...
      dispatch(
        createContact(nameValue, emailValue, subjectValue, messageValue)
      );
    ...
    // console.log(loading, success, contact)
    // console.log('disable va',this.state.disable)
    if (success) {
      alert("Thanks for the Message");
      setDisable(false);
    }
  }, [loading, success, contact]);
                  ...
                  <div className="form-box">
                    <form id="form_contact" className="form">
                      <Row>
                        ...
                        <Col md="12">
                          <button disabled={!disable}>Send Message</button>
                        </Col>
                      </Row>
                    </form>
                  </div>
